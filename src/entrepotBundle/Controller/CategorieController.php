...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('entrepotBundle:Categorie')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('entrepotBundle\Form\CategorieType', $categorie);
        $form->handleRequest($request);

        if ($form->isSubmitted() && $form->isValid()) {
            $em = $this->getDoctrine()->getManager();
            $categorie->UploadProfilePicture();
            //$categorie->uploadProfilePicture($this->getParameter('upload_directory'));
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('entrepotBundle\Form\CategorieType', $categorie);
    ...
    {
        $em=$this->getDoctrine()->getManager();
        $variable=$em->getRepository(Categorie::class)->find($id);
        $em->remove($variable);
        $em->flush();
